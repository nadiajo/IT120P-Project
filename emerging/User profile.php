...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="streetAddress" name="streetAddress" value="<?php echo $userData['street_address'] ?? ''; ?>" required>
    </div>
</div>
<div class="form-row">
    <div class="form-group col-md-6">
        <label for="city">City:</label>
        <input type="city" class="form-control" id="city" name="city" value="<?php echo $userData['city'] ?? ''; ?>" readonly>
    </div>
    <div class="form-group col-md-6">
...
<label for="region">Contact Number:</label>
        <input type="text" class="form-control" id="phoneNumber" name="phoneNumber" value="<?php echo $userData['phone_number'] ?? ''; ?>" required>
