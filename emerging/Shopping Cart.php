      ...
      <div class="col-md-4">
        <div class="delivery-address-container rounded">
          ...
          <div class="delivery-address-header">
            ...
            <button onclick="window.location.href='user Nprofile.php'" style="background-color: black; color: white;  border-radius: 8px; width: 70px; padding: 5px 10px; font-size: 15px; letter-spacing: 1px; cursor: pointer;" >EDIT</button>
          </div>
        </div>
